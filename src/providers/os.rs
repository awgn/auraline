...
static OS_MAP: phf::Map<&'static str, OsInfo> = phf_map! {
    "almalinux" => OsInfo { icon: "", color: "#FF4649", cterm_color: "203", name: "Almalinux" },
    "alpine" => OsInfo { icon: "", color: "#0D597F", cterm_color: "24", name: "Alpine" },
    "amzn" => OsInfo { icon: "", color: "#FF9900", cterm_color: "208", name: "AmazonLinux" },
    ...
    "cachyos" => OsInfo { icon: "󰣇", color: "#0F94D2", cterm_color: "67", name: "CachyOs" },
    "centos" => OsInfo { icon: "", color: "#A2518D", cterm_color: "132", name: "Centos" },
    "clear-linux-os" => OsInfo { icon: "", color: "#005697", cterm_color: "25", name: "ClearLinux" },
    ...
    "endeavouros" => OsInfo { icon: "", color: "#7B3DB9", cterm_color: "91", name: "Endeavour" },
    ...
    "neon" => OsInfo { icon: "", color: "#20A6A4", cterm_color: "37", name: "KDEneon" },
    "kubuntu" => OsInfo { icon: "", color: "#007AC2", cterm_color: "32", name: "Kubuntu" },
    "linux" => OsInfo { icon: "", color: "#FDFDFB", cterm_color: "231", name: "Linux" },
    "linuxmint" => OsInfo { icon: "󰣭", color: "#66AF3D", cterm_color: "70", name: "Mint" },
    ...
    "mx" => OsInfo { icon: "", color: "#FFFFFF", cterm_color: "231", name: "MXLinux" },
    ...
    "ol" => OsInfo { icon: "", color: "#FF0000", cterm_color: "196", name: "OracleLinux" },
    "openbsd" => OsInfo { icon: "", color: "#F2CA30", cterm_color: "220", name: "OpenBSD" },
    "opensuse-leap" => OsInfo { icon: "", color: "#FBC75D", cterm_color: "221", name: "Leap" },
    "opensuse-tumbleweed" => OsInfo { icon: "", color: "#35B9AB", cterm_color: "37", name: "Tumbleweed" },
    ...
    "pop" => OsInfo { icon: "", color: "#48B9C7", cterm_color: "73", name: "Pop_OS" },
    "postmarketos" => OsInfo { icon: "", color: "#009900", cterm_color: "28", name: "postmarketOS" },
    "puppy" => OsInfo { icon: "", color: "#A2AEB9", cterm_color: "145", name: "PuppyLinux" },
    "qubes" => OsInfo { icon: "", color: "#3774D8", cterm_color: "33", name: "QubesOS" },
    "raspbian" => OsInfo { icon: "", color: "#BE1848", cterm_color: "161", name: "RaspberryPiOS" },
    "rhel" => OsInfo { icon: "󱄛", color: "#EE0000", cterm_color: "196", name: "Redhat" },
    ...
    "sles" => OsInfo { icon: "", color: "#6FB424", cterm_color: "70", name: "SUSE" },
