...
pub struct Options {
    ...
    #[clap(short('M'), long, help = "Show development package info in the current directory")]
    pub manifest: bool,

    #[clap(short('D'), long, help = "Show the duration of the last command)")]
    pub duration: bool,
    ...
    #[clap(long, help = "Specify the prompt preset to use: minimal, lean, nerdy")]
...
impl Semigroup for Options {
    fn combine(&self, other: &Self) -> Self {
        Self {
            ...
            preset: self.preset.clone().or(other.preset.clone()),
        }
    }
}
